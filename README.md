...
L’ESP32 es comunica amb el Monitor Sèrie de l’ordinador utilitzant l’objecte Serial.
L’usuari escriu ordres (ON o OFF) i l’ESP32 encén o apaga un LED i respon amb un missatge pel port sèrie. Les ordres ignoren majúscules i minúscules.
...
(Comparació de cadenes ignorants majúscules/minúscules)
